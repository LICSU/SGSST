<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Resultado.aspx.cs" Inherits="source_Resultado" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="upRolSistema" runat="server">
            <ContentTemplate>
                <div class="row"><h1 class="text-info text-center">Resultado</h1></div>
                <div class="row">
                    <div class="col-lg-3"></div>
                    <div class="col-lg-3"></div>
                    <div class="col-lg-3"></div>
                    <div class="col-lg-3">
                        <asp:Button Text="Agregar Resultado" ID="btnAgregar" runat="server" OnClick="btnAgregar_Click" CssClass="btn-default" />
                    </div>
                </div>
                <br />
                <asp:GridView ID="GridView1" CssClass="footable" 
                              ...
                              EmptyDataText="No existen Resultados Agregados" >
                    <Columns>
                        <asp:TemplateField HeaderText="Resultado ID">
                            <ItemTemplate>
                                <asp:Label ID="id_resultado" runat="server" Enabled="false" Text='<%# Eval("id_resultado") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="form-group col-lg-12">
                                        <asp:HiddenField ID="hdfResultadoID" runat="server" />
                                        <label class="col-xs-4 control-label">Usuario: </label>
                                        <div class="col-xs-6">
                    ...
                    <asp:UpdatePanel ID="upDel" runat="server">
                        <ContentTemplate>
                            <div class="modal-body">
                                ...
                                <asp:HiddenField ID="hdfResultadoIDDel" runat="server" />
