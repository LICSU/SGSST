<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Departamento.aspx.cs" Inherits="source_Departamento" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="upRolSistema" runat="server">
            <ContentTemplate>
                <div class="row"><h1 class="text-info text-center">Departamento</h1></div>
                <div class="row">
                    <div class="col-lg-3"></div>
                    <div class="col-lg-3"></div>
                    <div class="col-lg-3"></div>
                    <div class="col-lg-3">
                        <asp:Button Text="Agregar Departamento" ID="btnAgregar" runat="server" OnClick="btnAgregar_Click" CssClass="btn-default" />
                    </div>
                </div>
                <br />
                <asp:GridView ID="GridView1" CssClass="footable" 
                              ...
                              DataKeyNames="id_departamento"  PageSize="20"
                              onpageindexchanging="GridView1_PageIndexChanging"
                              EmptyDataText="No existen Departamentos Agregados" >
                    <Columns>
                        <asp:TemplateField HeaderText="ID">
                            <ItemTemplate>
                                <asp:Label ID="id_departamento" runat="server" Enabled="false" Text='<%# Eval("id_departamento") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 id="H1">Agregar Departamento</h3>
                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 id="H2">Editar Departamento</h3>
                    </div>
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="form-group col-lg-12">
                                        <asp:HiddenField ID="hdfDepartamentoID" runat="server" />
                                        <label class="col-xs-4 control-label">Nombre: </label>
                                        <div class="col-xs-6">
                    ...
                    <asp:UpdatePanel ID="upDel" runat="server">
                        <ContentTemplate>
                            <div class="modal-body">
                                ...
                                <asp:HiddenField ID="hdfDepartamentoIDDel" runat="server" />
