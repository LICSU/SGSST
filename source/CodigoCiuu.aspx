<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CodigoCiuu.aspx.cs" Inherits="source_CodigoCiuu" %>
<!DOCTYPE html>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="upRolSistema" runat="server">
            <ContentTemplate>
                <div class="row"><h1 class="text-info text-center">Codigo Ciiu</h1></div>
                <div class="row">
                ...
                <asp:GridView ID="GridView1" CssClass="footable" 
                              ...
                              DataKeyNames="id_codigo_ciiu"  PageSize="20"
                              onpageindexchanging="GridView1_PageIndexChanging"
                              EmptyDataText="No existen Códigos Agregados" >
                    <Columns>
                        <asp:TemplateField HeaderText="ID">
                            <ItemTemplate>
                                <asp:Label ID="id_codigo_ciiu" runat="server" Enabled="false" Text='<%# Eval("id_codigo_ciiu") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 id="H2">Editar Código</h3>
                    </div>
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <div class="modal-body">
                                 <div class="row">
                                   <asp:HiddenField runat="server" ID="hdfCodigoIDEDit" />
                                   <div class="form-group col-lg-12">
                                        <label class="col-xs-4 control-label">Nombre: </label>
                                        <div class="col-xs-6">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 id="delModalLabel">Eliminar Código</h3>
                    </div>
                    <asp:UpdatePanel ID="upDel" runat="server">
                        <ContentTemplate>
                            <div class="modal-body">
                                ¿Seguro desea eliminar este registro?
                                <asp:HiddenField runat="server" ID="hdfCodigoIDDel" />
