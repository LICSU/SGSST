<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AgregarTrabajador.aspx.cs" Inherits="source_AgregarTrabajador" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="">
            <div class="col-lg-12">
                ...
                <div class="col-lg-8">
                    <div class="col-lg-12 text-center"><h1>Agregar Trabajador</h1></div>
                    <br />
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="">
                            <div class="col-lg-6 text-right">
                                <asp:Button runat="server" ID="btnAceptar" Text="Aceptar" OnClick="btnAceptar_Click" CssClass="btn btn-default" ></asp:Button>
                            </div>
                            <div class="col-lg-6 text-left">
