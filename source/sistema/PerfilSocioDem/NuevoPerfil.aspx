<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NuevoPerfil.aspx.cs" Inherits="source_sistema_PerfilSocioDem_NuevoPerfil" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="col-lg-12">
            <h3 class="text-center">Nuevo Registro del Perfil SocioDemografico</h3>
        </div>
        <p>&nbsp;</p>
        ...
        <div class="col-lg-10">
            <div class="col-lg-12">
                <div class="col-lg-6">
                    ...
                    <div class="col-lg-12 text-left">
                        <asp:DropDownList runat="server" ID="ddlTrabajador" CssClass="form-control"></asp:DropDownList>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="col-lg-12 text-left">
                ...
                <div class="col-lg-6 text-left">
                    ...
                    <div class="col-lg-12">
                        <asp:RadioButtonList runat="server" ID="rdlCabeza" CssClass="radio-inline">
                            <asp:ListItem Text="Si" Selected="True" Value="SI"></asp:ListItem>
                ...
                <div class="col-lg-6 text-left">
                    ...
                    <div class="col-lg-12">
                        <asp:RadioButtonList runat="server" ID="rblResponsabilidad" CssClass="radio-inline">
                            <asp:ListItem Selected="True" Text="Con Nadie" Value="Con Nadie"></asp:ListItem>
                ...
                <div class="col-lg-6 text-left">
                    ...
                    <div class="col-lg-12">
                        <asp:RadioButtonList runat="server" Enabled="false" ID="rblMotivo" CssClass="radio-inline" AutoPostBack="true" OnSelectedIndexChanged="rblMotivo_SelectedIndexChanged">
                            <asp:ListItem Selected="True" Text="Violencia sociopolítica" Value="Violencia sociopolítica"></asp:ListItem>
                ...
                <div class="col-lg-6 text-left">
                    ...
                    <div class="col-lg-12">
                        <asp:RadioButtonList runat="server" ID="dblVivienda" CssClass="radio-inline">
                            <asp:ListItem Selected="True" Text="Propia" Value="Propia"></asp:ListItem>
                ...
                <div class="col-lg-6 text-left">
                    ...
                    <div class="col-lg-12">
                        <asp:RadioButtonList runat="server" ID="dblSeguridad" CssClass="radio-inline">
                            <asp:ListItem Selected="True" Text="Si" Value="Si"></asp:ListItem>
                ...
                <div class="col-lg-6 text-left">
                    ...
                    <div class="col-lg-12">
                        <asp:RadioButtonList runat="server" ID="rblRegimen" CssClass="checkbox-inline">
                            <asp:ListItem Selected="True" Text="Contributivo (pasar a la pregunta 14)" Value="Contributivo"></asp:ListItem>
            ...
            <div class="col-lg-12">
                <div class="col-lg-6 text-left">
                     <div class="col-lg-12">
                        20) ¿Cuañ es el estrato que registran sus facturas de los servicios públicos de la vivienda donde reside?
                    </div>
                    <div class="col-lg-12">
                        <asp:RadioButtonList runat="server" ID="rblEstrato" CssClass="radio-inline" RepeatColumns="2">
                            <asp:ListItem Selected="True" Text="Estrato 1" Value="Estrato 1"></asp:ListItem>
            ...
            <p>&nbsp;</p>
            <div class="col-lg-12">
                <asp:Button runat="server" Text="Guardar" CssClass="btn btn-default" ID="btnGuardar" OnClick="btnGuardar_Click" />
            </div>                          
        </div>
        <div class="col-lg-1"></div>
        <!-- Fin del Contenido -->
